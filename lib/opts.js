...
function getOptions(options, environ, cb) {
  ...
  // The name of a particular resource of interest within the stack.
  opts.resource_name = getOption('resource_name', options);
  if (!opts.resource_name) {
    opts.resource_name = null;
  }
  ...
  //
  // Whether to clear any cached machine images.
  opts.clear_cached_boxen = getOption('clear_cached_boxen', options) || false;
